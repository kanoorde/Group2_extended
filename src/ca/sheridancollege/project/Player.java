...
public class Player {
    public static void main(String[] args) {
        ...
        // Scanner is used for taking the input from the user.
        Scanner scanner = new Scanner(System.in);

        
        // This is used to specific which the next move of the user.
        while (true) {
            game.printGameState();
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    if (!game.moveCardBetweenPiles(fromPile, toPile)) {
